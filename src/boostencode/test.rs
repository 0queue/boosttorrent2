...
fn test_parse_integer_literal() {
    ...
    let res = parse_integer_literal(s123.as_mut());
    assert_eq!(res, 123);
}
...
fn test_parse_bstring() {
    ...
    let val = parse_bstring(s1.as_mut());
...
fn test_parse_integer() {
    ...
    let val1 = parse_integer(s1.as_mut());
    let val2 = parse_integer(s2.as_mut());
...
fn test_parse_integer_negative_zero() {
    ...
    let _val1 = parse_integer(s1.as_mut());
}
...
fn test_parse_dict_not_ascending() {
    ...
    let _val1 = parse_dict(s1.as_mut());
}
